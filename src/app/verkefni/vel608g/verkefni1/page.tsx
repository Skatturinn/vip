...
export default function Page() {
	return <>
		<h1>Verkefni 1</h1>
		<p>Tilgangur þessara síðu er að uppfylla öll innihalds skilyrði fyrir vefsíðu í áfanganum tölvustuddframleiðsla</p>
		<p>VÉL608G</p>
		<section className={styles.sec}>
			...
			<ol className={styles.efnislit}>
				<li><a href="#v11" style={{ border: 0 }}>1. Lýsing á framkvæmd</a></li>
				<li><a href="#v12" style={{ border: 0 }}>2. Óskir varðandi áfanga</a></li>
				<li><a href="#v13" style={{ border: 0 }}>3. Notkun á git</a></li>
			</ol>
